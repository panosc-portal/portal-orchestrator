...
http --ignore-stdin POST kong:8001/services/ name=logging-service url=http://logging-service/
...
http --ignore-stdin POST kong:8001/routes/ name=logging-service service:='{"name":"logging-service"}' paths:='["/logging-service/"]'
...
http --ignore-stdin POST kong:8001/upstreams/ name=logging-service
...
http --ignore-stdin POST kong:8001/upstreams/logging-service/targets/ target=logging-service:4030
