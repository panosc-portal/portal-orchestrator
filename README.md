...
The following commands will manually configure Kong:

```bash
http POST localhost:8001/services/ name=api-service url=http://api-service/
http POST localhost:8001/services/ name=desktop-service url=http://desktop-service/
http POST localhost:8001/services/ name=desktop-service-ws url=http://desktop-service-ws/socket.io
...
http POST localhost:8001/routes/ name=desktop-service-route service:='{"name":"desktop-service"}' paths:='["/desktop-service/"]'
http POST localhost:8001/routes/ name=desktop-service-ws-route service:='{"name":"desktop-service-ws"}' paths:='["/desktop-service/ws"]'
...
http POST localhost:8001/upstreams/ name=desktop-service
http POST localhost:8001/upstreams/ name=desktop-service-ws
...
http POST localhost:8001/upstreams/desktop-service/targets/ target=desktop-service:4021
http POST localhost:8001/upstreams/desktop-service-ws/targets/ target=desktop-service:4022
...
The following is an example VS Code launch config to connect to a Javascript debugger (you may need tp change the `localRoot` accordingly depending on where you launch the debugging task):
```json
{
    "address": "localhost",
